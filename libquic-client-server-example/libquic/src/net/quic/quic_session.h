...
//QuicServerSession  QuicClientSession  QuicSpdySession继承该QuicSession类, VisitorShim和ReliableQuicStream类中包含该类成员
class NET_EXPORT_PRIVATE QuicSession : public QuicConnectionVisitorInterface {
 ...
 private:
  ...
  //QuicDispatcher::CreateQuicSession中new该类
  scoped_ptr<QuicConnection> connection_;

  // A shim to stand between the connection and the session, to handle stream
  // deletions.   QuicSession::QuicSession中默认初始化visitor_shim_(new VisitorShim(this)),
